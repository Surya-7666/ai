    ...
    >
      ...
      <div className="flex justify-center px-4 pt-32 pb-20">
        ...
        >
          ...
          {/* STEPS */}
          <ol
            className={`space-y-3 text-sm ${themeStyles.sub} list-decimal list-inside`}
          >
          ...
          <div className="mt-14">
            ...
            <div className={`rounded-xl overflow-hidden ${themeStyles.glass}`}>
              <div className="flex items-center gap-2 px-4 h-9 border-b border-white/10">
                ...
                <span className={`ml-4 text-xs ${themeStyles.sub}`}>
                  yourwebsite.com
                </span>
              </div>
              ...
              <div className={`relative h-64 p-6 text-sm ${themeStyles.sub}`}>
                ...
                <div
                  className={`absolute bottom-24 right-6 w-64 rounded-xl overflow-hidden ${themeStyles.glass}`}
                >
                  ...
                  <div className="p-3 space-y-2">
                    ...
                    <div className="bg-green-500 text-white px-3 py-2 rounded-lg text-xs ml-auto">
                      Return policy?
                    </div>
                  </div>
                </div>
